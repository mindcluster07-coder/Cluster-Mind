...
import { AI_RECOMMENDATIONS } from '../../data/adminMockData'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {AI_RECOMMENDATIONS.stats.map((s, i) => {
      ...
      {activeTab === 'fbt' && (
        <ChartCard title="Frequently Bought Together" subtitle="Product bundles">
          <div className="space-y-3">
            {AI_RECOMMENDATIONS.frequentlyBoughtTogether.map((b, i) => (
      ...
      {activeTab === 'history' && (
        <ChartCard title="Recommendation History" subtitle="Daily recommendation performance">
          <DataTable columns={historyCols} rows={AI_RECOMMENDATIONS.history} />
        </ChartCard>
      )}
    </div>
  )
