...
import { USER_ROLES, ADMIN_USERS, ACTIVITY_LOGS } from '../../data/adminMockData'
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">{ADMIN_USERS.length} admin users, {USER_ROLES.length} roles</p>
        </div>
